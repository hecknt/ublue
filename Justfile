...
images := '(
    ...
    [aurora-nvidia]="aurora"
    [aurora-bazzite-kernel-nvidia]="aurora"
    [bazzite]="bazzite"
    [bazzite-nvidia]="bazzite"
    [bazzite-deck]="bazzite-deck"
    [bazzite-deck-nvidia]="bazzite-deck"
    [bluefin-latest]="bluefin"
    [bluefin-latest-nvidia]="bluefin"
    [bluefin-gdx]="bluefin-gdx"
    [bluefin-lts]="bluefin"
    [bluefin]="bluefin"
    [bluefin-nvidia]="bluefin"
    [cayo]="fedora"
    [ucore-minimal]="stable"
    [ucore-hci]="stable-zfs"
    [ucore-hci-nvidia]="stable-zfs"
    [ucore]="stable-zfs"
    [ucore-nvidia]="stable-zfs"
    [danklinux]="base-main"
    [danklinux-nvidia]="base-nvidia"
    [danklinux-bazzite-kernel]="base-main"
    [danklinux-bazzite-kernel-nvidia]="base-main"
)'
